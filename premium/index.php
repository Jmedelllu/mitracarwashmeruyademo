...
<section class="hero">
  <div class="container hero__grid">
    <div>
      <div class="section__kicker">Premium Package</div>
      ...
      <div class="hero__actions">
        <a class="btn btn--primary" href="/Bisinis/premium/contact.php">Kirim Inquiry</a>
        <a class="btn" href="<?= h($waHref) ?>" target="_blank" rel="noopener noreferrer">Chat WhatsApp</a>
        <a class="btn btn--ghost" href="/Bisinis/premium/services.php">Lihat Layanan</a>
      </div>
    </div>
    ...
    <aside class="panel" aria-label="Ringkasan">
      <div class="panel__body">
        ...
        <div class="panel__meta">
          <span class="chip">4 halaman</span>
          <span class="chip">Maps</span>
          <span class="chip">WhatsApp</span>
          <span class="chip">Form kontak</span>
        </div>
      </div>
    </aside>
  </div>
...
<aside class="drawer" data-cart-drawer aria-label="Keranjang layanan">
  ...
  <div class="drawer__foot">
    ...
    <div class="checkout">
      ...
      <a class="btn" href="/Bisinis/premium/contact.php">Kirim Inquiry</a>
