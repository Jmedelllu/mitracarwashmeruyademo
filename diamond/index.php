...
<section class="hero">
  <div class="container hero__grid">
    <div>
      <div class="section__kicker">Diamond Package</div>
      ...
      <div class="hero__actions">
        <a class="btn btn--primary" href="/Bisinis/diamond/landing.php">Campaign</a>
        <a class="btn" href="<?= h($waHref) ?>" target="_blank" rel="noopener noreferrer">Chat WhatsApp</a>
        <a class="btn btn--ghost" href="/Bisinis/diamond/services.php">Lihat Layanan</a>
      </div>
    </div>
    ...
    <aside class="panel" aria-label="Ringkasan">
      <div class="panel__body">
        ...
        <div class="panel__meta">
          <span class="chip">Unlimited pages</span>
          <span class="chip">Campaign</span>
          <span class="chip">Blog</span>
          <span class="chip">SEO basic</span>
        </div>
      </div>
    </aside>
  </div>
        ...
        <div class="panel card--big reveal" data-reveal>
          <div class="panel__body">
            ...
            <div style="display:flex;gap:12px;flex-wrap:wrap">
              <a class="btn btn--primary" href="/Bisinis/diamond/contact.php">Kirim Inquiry</a>
              <a class="btn" href="<?= h($waHref) ?>" target="_blank" rel="noopener noreferrer">Chat WhatsApp</a>
            </div>
          </div>
        </div>
...
<aside class="drawer" data-cart-drawer aria-label="Keranjang layanan">
  ...
  <div class="drawer__foot">
    ...
    <div class="checkout">
      ...
      <a class="btn" href="/Bisinis/diamond/contact.php">Kirim Inquiry</a>
